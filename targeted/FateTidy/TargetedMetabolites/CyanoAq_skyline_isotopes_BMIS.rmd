...
column.id = "CyanoAq"
filename <- "../output/TargetedMetabolites/CyanoAq_QC_skyline_IS_data.csv"
...
SampKey <- read_csv("../RawData/Cyano Sample List.csv") %>%
...
IS.dat <- IS.dat %>%
  ...
  filter(MassFeature != "Alpha-Tocopherol, D6 - IS",
         MassFeature != "Arachiodonic Acid, D8 - IS",
         MassFeature != "Docosahexaenoic Acid, D5 - IS",
         MassFeature != "Eicosapentaenoic Acid, D5 - IS")# %>%
...
# write.csv(newalldat,  paste0("../../output/skyline/",column.id,"_IS_testResults.csv"))
...
# ggsave(paste0("../../output/skyline/",column.id,"_IS_experiment_wPool.pdf"), plot = g, device = "pdf", width = 10, height = 10, units = "in")
```
...
# write.csv(Summary, paste0("../../output/skyline/",column.id,"_AMISvsBMIS.csv"),sep="")

# ggsave( paste0("../../output/skyline/",column.id,"_AMISvsBMIS.pdf"), plot = g, device = "pdf", width = 10, height = 10, units = "in")
...
FullDat_fixed.update <- FullDat_fixed %>%
  mutate(FinalBMIS = ifelse(MassFeature == "Alanine", "DL-Alanine, D3 - IS.Norm.Area",
                      ...
                      ifelse(MassFeature == "AMP", "AMP - IS.Norm.Area",
                      ifelse(MassFeature == "AMP_13C-0 15N-0", "AMP - IS.Norm.Area",
                      ifelse(MassFeature == "GMP", "GMP - IS.Norm.Area",
                      ifelse(MassFeature == "GMP_13C-0 15N-0", "GMP - IS.Norm.Area",
                      ifelse(MassFeature == "Sucrose", "Heavy Sucrose - IS.Norm.Area",
                      ifelse(MassFeature == "Sucrose_13C-0 15N-0", "Heavy Sucrose - IS.Norm.Area",
                      ifelse(MassFeature == "Trehalose", "Heavy Trehalose - IS.Norm.Area",
                      ifelse(MassFeature == "Trehalose_13C-0 15N-0", "Heavy Trehalose - IS.Norm.Area",
                      ifelse(MassFeature == "Sulfoacetic Acid", "Sulfoacetic Acid - IS.Norm.Area",
                      ifelse(MassFeature == "Sulfoacetic Acid_13C-0 15N-0", "Sulfoacetic Acid - IS.Norm.Area",
                      ifelse(MassFeature == "Isethionic acid", "Isethionic acid - IS.Norm.Area",
                      ifelse(MassFeature == "Isethionic acid_13C-0 15N-0", "Isethionic acid - IS.Norm.Area",
                      ifelse(MassFeature == "Succinic acid", "Succinic acid - IS.Norm.Area",
                      ifelse(MassFeature == "Succinic acid_13C-0 15N-0", "Succinic acid - IS.Norm.Area",
                      ifelse(MassFeature == "L-Cysteic acid", "L-Cysteic acid - IS.Norm.Area",
                      ifelse(MassFeature == "L-Cysteic acid_13C-0 15N-0", "L-Cysteic acid - IS.Norm.Area",
                             
                      ifelse(MassFeature == "Sulfolactic acid", "Sulfolactic acid - IS.Norm.Area",
                      ifelse(MassFeature == "Sulfolactic acid_13C-0 15N-0", "Sulfolactic acid - IS.Norm.Area",
